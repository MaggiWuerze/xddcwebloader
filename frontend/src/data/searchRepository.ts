...
export const SearchRepository = {
    ...
    async search({
        ...
        let searchData = await api.searchWithProvider(provider,query, paginationModel.page, paginationModel.pageSize).then((rs) => rs.data);
        return {
            items: searchData.results,
            itemCount: searchData.totalItems,
        };
    }
};